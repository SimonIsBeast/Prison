...
public class Ranks implements Component {
    ...
    public void enable() throws FailedToStartException {
        ...
        if (permission == null || permission.getName()
            .equalsIgnoreCase("superperms")) { // We ain't allowing no SuperPerms!
            Prison.l.severe(
    ...
    private boolean load() {
        ...
        Map<String, Integer> convertedValues =
            null; // If this is not null, the conversion has occurred
    ...
    public void promote(String name, boolean buy) {
        ...
        if (info != null) {
            ...
            if (nextRank == null) {
                info.getPlayer().sendMessage(buy ?
                    ...
                    if (eco.has(info.getPlayer(), nextRank.getPrice())) {
                        ...
                        if (info.getPlayer() != null) {
                            double amountNeededD =
                                nextRank.getPrice() - eco.getBalance(info.getPlayer());
                            String amountNeeded =
